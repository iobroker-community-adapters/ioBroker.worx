...
```json
{
    "states": {
        ...
        "1": "Trapped", //(Draht & Vision & RTK)
        "2": "Lifted", //(Draht & Vision & RTK)
        "3": "Wire missing", //(Draht)
        "4": "Outside boundary", //(Draht & Vision & RTK)
        "5": "Raining", //(Draht & Vision & RTK)
        "6": "Close door to mow", //(Draht)
        "7": "Close door to go home", //(Draht)
        "8": "Blade motor blocked", //(Draht & Vision & RTK)
        "9": "Wheel motor blocked", //(Draht & Vision & RTK)
        "10": "Trapped timeout", //(Draht & Vision & RTK)
        "11": "Upside down", //(Draht & Vision & RTK)
        "12": "Battery low", //(Draht & Vision & RTK)
        "13": "Reverse wire", //(Draht)
        "14": "Charge error", //(Draht & Vision & RTK)
        ...
        "116": "Blade height adjustment blocked", //(RTK)
        "117": "Unsupported blade heigh", //(RTK)
        "118": "Manual firrnware upgrade required", //(RTK)
        "119": "Area limit exceeded", //(RTK)
        "120": "Charging station undocking error" //(RTK)
    }
}
```
...
```json
{
    "states": {
        ...
        "9": "Safe homing", //(Draht & Vision & RTK)
...
{
    "states": {
        "0": "IDLE", //(Draht & Vision & RTK)
        "1": "Home", //(Draht & Vision & RTK)
        "2": "Start sequence", //(Draht)
        "3": "Leaving home", //(Draht & Vision & RTK)
        "4": "Following border", //(Draht)
        "5": "Searching home", //(Draht & Vision & RTK)
        "6": "Searching border", //(Draht & Vision)
        "7": "Mowing", //(Draht & Vision & RTK)
        "8": "Lifted", //(Draht & Vision & RTK)
        "9": "Trapped", //(Draht & Vision & RTK)
        "10": "Blade blocked", //(Draht & Vision & RTK)
        "11": "Debug", //(Draht & Vision & RTK)
        "12": "Driving", //(Draht & Vision)
        ...
        "34": "Pause", //(Draht & Vision & RTK)
        "100": "Map training", //(RTK)
        "101": "Map processing", //(RTK)
        "102": "Upgrading firmware", //(RTK)
        "103": "Moving to zone", //(RTK)
        "104": "Going home", //(RTK)
        "105": "Ready for training", //(RTK)
        "106": "Map download in progress", //(RTK)
        "107": "Map upload in progress", //(RTK)
        "108": "Map training paused", //(RTK)
        "109": "Map training (not completable)", //(RTK)
        "110": "Border crossing", //(Vision)
        "111": "Exploring lawn", //(Vision)
        "112": "Moving to recovery point", //(RTK)
        "113": "Waiting for position", //(RTK)
        "114": "Map training (driving)", //(Vision)
