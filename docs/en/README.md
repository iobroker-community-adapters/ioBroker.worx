...
{
    "states": {
        "0": "No error", //(wire & Vision & RTK)
        "1": "Trapped", //(wire & Vision & RTK)
        "2": "Lifted", //(wire & Vision & RTK)
        "3": "Wire missing", //(wire)
        "4": "Outside boundary", //(wire & Vision & RTK)
        "5": "Raining", //(wire & Vision & RTK)
        "6": "Close door to mow", //(wire)
        "7": "Close door to go home", //(wire)
        "8": "Blade motor blocked", //(wire & Vision & RTK)
        "9": "Wheel motor blocked", //(wire & Vision & RTK)
        "10": "Trapped timeout", //(wire & Vision & RTK)
        "11": "Upside down", //(wire & Vision & RTK)
        "12": "Battery low", //(wire & Vision & RTK)
        "13": "Reverse wire", //(wire)
        "14": "Charge error", //(wire & Vision & RTK)
        "15": "Timeout finding home", //(wire & Vision)
        "16": "Mower locked", //(wire & Vision)
        "17": "Battery over temperature", //(wire & Vision & RTK)
        "18": "dummy model", //(wire)
...
{
    "states": {
        "0": "IDLE", //(wire & Vision & RTK)
        "1": "Home", //(wire & Vision & RTK)
        "2": "Start sequence", //(wire)
        "3": "Leaving home", //(wire & Vision & RTK)
        "4": "Following border", //(wire)
        "5": "Searching home", //(wire & Vision & RTK)
        "6": "Searching border", //(wire & Vision)
        "7": "Mowing", //(wire & Vision & RTK)
        "8": "Lifted", //(wire & Vision & RTK)
        "9": "Trapped", //(wire & Vision & RTK)
        "10": "Blade blocked", //(wire & Vision & RTK)
        "11": "Debug", //(wire)
